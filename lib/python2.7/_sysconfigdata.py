...
build_time_vars = {'AC_APPLE_UNIVERSAL_BUILD': 0,
 ...
 'CONFIG_ARGS': "'prefix=/usr/local/python2' '--enable-shared'",
 ...
 'COVERAGE_INFO': '/usr/local/src/Python-2.7.18/coverage.info',
 'COVERAGE_REPORT': '/usr/local/src/Python-2.7.18/lcov-report',
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': 'LD_LIBRARY_PATH=/usr/local/src/Python-2.7.18',
 ...
 'TESTPYTHON': 'LD_LIBRARY_PATH=/usr/local/src/Python-2.7.18 ./python -Wd -3 -E -tt',
 'TESTPYTHONOPTS': '',
 ...
 'abs_builddir': '/usr/local/src/Python-2.7.18',
 'abs_srcdir': '/usr/local/src/Python-2.7.18',
